...
echo -e "${BLUE}🚀 Запуск тестирования производительности диалогов с PostgreSQL${NC}"
echo "=================================================================="
...
for i in {1..30}; do
    ...
    if [ $i -eq 30 ]; then
        ...
        echo -e "${YELLOW}💡 Запустите сервис командой: docker-compose --profile postgresql up -d${NC}"
        exit 1
    fi
